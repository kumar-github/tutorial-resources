...
* [Spring Boot Externalized Configuration 101](#spring-boot-externalized-configuration-101)
    ...
    * [Commit-00 :sparkles:](#commit-00-sparkles)
        ...
        * [Run the project from command line using java jar](#run-the-project-from-command-line-using-java-jar)
...
| 4. Run the project from command line using java jar. | :white_check_mark: |
...
### Run the project from command line using java jar
