...
```terminaloutput
Stats: TimingStatistics[Total iterations = 1000, Successful iterations = 950, Failed iterations = 50,
...
50 out of 1000 iterations failed. Last exception: org.postgresql.util.PSQLException: The connection attempt failed
```
